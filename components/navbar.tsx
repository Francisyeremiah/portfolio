      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-zinc-900/60 backdrop-blur-sm border-b border-zinc-800">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            {/* Logo */}
            <Link href="/images/fen.png" className="font-bold text-xl">
              <span className="bg-gradient-to-r from-green-400 bg-green-900 bg-clip-text text-transparent">
                Francis
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <Button size="sm" className="ml-4 bg-green-900 hover:bg-green-700 text-white">
                Hire Me
              </Button>
            </div>
          ...
          <div className="md:hidden bg-zinc-900/98 backdrop-blur-sm border-t border-zinc-800">
            <div className="px-6 py-4 space-y-2">
              ...
              <div className="pt-4 mt-4 border-t border-zinc-800">
                <Button className="w-full bg-green-900 hover:bg-green-700 text-white" onClick={closeMenu}>
                  Hire Me
                </Button>
              </div>
            </div>
