...
const socialLinks = [
  {
    name: "GitHub",
    icon: Github,
    url: "https://github.com/Heatherfeng",
  ...
  },
  {
    name: "LinkedIn",
    icon: Linkedin,
    url: "https://linkedin.com/in/heather-feng-427999383?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  ...
  },
  {
    name: "Facebook",
    icon: Facebook,
    url: "https://facebook.com/heather.feng.66212",
  ...
  },
  {
    name: "Instagram",
    icon: Instagram,
    url: "https://instagram.com/feng.heather?igsh=cjZiNTBpbjFramt6",
    color: "hover:text-green-400",
    bgColor: "hover:bg-green-900/20",
  },
  {
    name: "Nthreads",
    icon: MessageSquare,
    url: "https://www.threads.com/@feng.heather",
    color: "hover:text-green-400",
    bgColor: "hover:bg-green-900/20",
  },
]
...
const ContactPage = () => {
  ...
  if (state.succeeded) {
    return (
      <div className="bg-zinc-900 min-h-screen flex items-center justify-center p-6 hover:border-green-600/50  transition-all duration-300">
        <Card className="w-full max-w-md mx-auto p-8 bg-zinc-800/50 border border-zinc-700 shadow-2xl">
          <CardContent className="text-center space-y-6">
            ...
            <Button
              ...
              className="mt-6 bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-xl transition-all duration-300"
            >
    ...
    <div  className="bg-zinc-900 min-h-screen py-16 px-6">
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="text-center mb-12 ">
          ...
          <p className="text-gray-400 text-lg">Let’s turn your ideas into reality — one conversation at a time.</p>
        </div>

        <div className="grid lg:grid-cols-2 gap-12 items-start ">
          {/* Contact Form */}
          <Card className="bg-zinc-800/50 border border-zinc-700 shadow-xl hover:border-green-600/50  transition-all duration-300">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="text"
                    name="name"
                    className="bg-zinc-700/50 text-white border-zinc-600 focus:border-green-500 focus:ring-green-500/20 rounded-lg"
                    required
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="message"
                    name="message"
                    className="bg-zinc-700/50 text-white border-zinc-600 focus:border-green-500 focus:ring-green-500/20 min-h-[120px] rounded-lg resize-none"
                    required
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-gray-300">
                  <div className="flex items-center">
                    ...
                    <span>heatherfeng00@gmail.com</span>
                  </div>
                  <div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <User className="w-4 h-4 mr-3 text-green-400" />
                    <span>Response within 24/7 hours</span>
                  </div>
                </div>
              </CardContent>
            </Card>
